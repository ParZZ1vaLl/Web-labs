export default class Work{
    ...
    _action = () => {
        this.canvas.width = this.parent.scrollWidth * 0.65 - 10
        this.canvas.height = this.parent.scrollHeight * 0.75 - 50
        this.square.fillStyle = "green"
        this.square.clearRect(0, 0 ,this.canvas.width + 10, this.canvas.height + 10)
            this.square.fillRect(this.x, this.y, 10, 10)
            if(this.y + 1 * this.deg + 10 > this.canvas.height && this.direction == 1) {
                this.x -= (this.y - this.canvas.height) / this.deg
